...
class LuaTemplate:
    ...
    def render(self, context: dict) -> str:
        ...
        lua_code.extend([
            ...
            "function Precombat()",
            "    -- Precombat setup",
            "    if Spell.UseFlask:IsReady() then",
            "        return Cast(Spell.UseFlask)",
            "    end",
            "",
            "    if Spell.UseFood:IsReady() then",
            "        return Cast(Spell.UseFood)",
            "    end",
            "",
            "    if Spell.SnapshotStats:IsReady() then",
            "        return Cast(Spell.SnapshotStats)",
            "    end",
            "end",
            "",
            "function Default()",
            "    -- Default action list",
            "    if Spell.DemonSpikes:IsReady() and Cache:Get('use_defensives') then",
            "        return Cast(Spell.DemonSpikes)",
            "    end",
            "",
            "    if Spell.FieryBrand:IsReady() and Cache:Get('use_defensives') then",
            "        return Cast(Spell.FieryBrand)",
            "    end",
            "",
            "    if Spell.Metamorphosis:IsReady() and Cache:Get('use_defensives') then",
        ...
        # Return rotation
        lua_code.append("return Rotation")
